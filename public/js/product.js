...
//         url: "http://192.168.8.104:8080/api/v1/product/saveProduct",
//         async: true,
//         data: JSON.stringify({
...
function updateProduct() {
  ...
  $.ajax({
    method: "PUT",
    contentType: "application/json",
    url: "http://192.168.8.104:8080/api/v1/product/updateProduct",
    async: true,
    data: JSON.stringify({
      productId: productId,
      productName: productName,
...
function deleteProduct() {
  ...
  $.ajax({
    ...
    contentType: "application/json",
    url:
      "http://192.168.8.104:8080/api/v1/product/deleteProductByProductName/" +
...
function getAllProducts() {
  $.ajax({
    method: "GET",
    contentType: "application/json",
    url: "http://192.168.8.104:8080/api/v1/product/getAllProducts",
    async: true,
    success: function (data) {
      if (data.code === "00") {
        $("#productTable").empty();
