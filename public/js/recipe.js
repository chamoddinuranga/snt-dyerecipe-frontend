...
function saveRecipe() {
  ...
  $.ajax({
    method: "POST",
    contentType: "application/json",
    url: "http://192.168.8.106:8080/api/v1/recipe/saveRecipe",
...
//   return $.ajax({
//     method: "GET",
//     url: `http://192.168.8.106:8080/api/v1/product/getProductByProductName/${encodeURIComponent(productName)}`,
//     dataType: "json"
...
$(document).ready(function () {
  ...
  function loadLabDipSuggestions(query) {
    $.ajax({
      ...
      contentType: "application/json",
      url:
        "http://192.168.8.106:8080/api/v1/recipe/searchLabDips?query=" +
        encodeURIComponent(query),
      success: function (response) {
        if (response.code === "00") {
          let suggestions = response.content;
...
$(document).ready(function () {
  ...
  function searchRecipeByLabDip(labDip) {
    $.ajax({
      method: "GET",
      contentType: "application/json",
      url: `http://192.168.8.106:8080/api/v1/recipe/getRecipeByLabDip/${encodeURIComponent(
        labDip
      )}`,
      success: function (response) {
        if (response.code === "00") {
...
//       method: "GET",
//       contentType: "application/json",
//       url: `http://192.168.8.106:8080/api/v1/recipe/getRecipeByLabDip/${encodeURIComponent(labDip)}`,
//       success: function (response) {
//         if (response.code === "00") {
//           displayRecipe(response.content);
//         } else {
...
//     return $.ajax({
//       method: "GET",
//       url: `http://192.168.8.106:8080/api/v1/product/getProductByProductId/${productId}`,
//       dataType: "json"
//     }).then(function (response) {
//       if (response.code === "00" && response.content) {
