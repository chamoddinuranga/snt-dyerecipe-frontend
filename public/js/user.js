...
function saveUser() {
  ...
  $.ajax({
    ...
    url: "http://192.168.8.102:8080/api/v1/user/saveUser",
    async: true,
    data: JSON.stringify({
...
function updateUser() {
  ...
  $.ajax({
    method: "PUT",
    contentType: "application/json",
    url: "http://192.168.8.102:8080/api/v1/user/updateUser",
    async: true,
    data: JSON.stringify({
...
function deleteUser() {
  ...
  $.ajax({
    ...
    contentType: "application/json",
    url:
      "http://192.168.8.102:8080/api/v1/user/deleteUserByUserName/" +
...
function getAllUsers() {
  $.ajax({
    method: "GET",
    contentType: "application/json",
    url: "http://192.168.8.102:8080/api/v1/user/getAllUsers",
    async: true,
    success: function (data) {
      if (data.code === "00") {
        $("#empTable").empty();
