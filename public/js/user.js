...
function saveUser() {
  ...
  $.ajax({
    ...
    url: "http://192.168.8.104:8080/api/v1/user/saveUser",
    async: true,
    data: JSON.stringify({
...
function updateUser() {
  ...
  $.ajax({
    method: "PUT",
    contentType: "application/json",
    url: "http://192.168.8.104:8080/api/v1/user/updateUser",
    async: true,
    data: JSON.stringify({
...
function deleteUser() {
  ...
  $.ajax({
    ...
    contentType: "application/json",
    url:
      "http://192.168.8.104:8080/api/v1/user/deleteUserByUserName/" +
